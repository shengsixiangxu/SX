    ...
    let handle={
        get: function(target, prop, receiver) {
            ...
            if(prop.indexOf('response')!==-1)
            {
                ...
                if(result.indexOf('"Answer":"A"')!==-1)
                {
                    result = ("Answer:A")
                    alert(result)
                }

                if(result.indexOf('"Answer":"C"')!==-1)
                {
                    result = ("Answer:C")
                    alert(result)
                }

                if(result.indexOf('"Answer":"D"')!==-1)
                {
                    result = ("Answer:D")
                    alert(result)
                }

                if(result.indexOf('"Answer":"AB"')!==-1)
                {
                    result = ("Answer:AB")
                    alert(result)
                }

                if(result.indexOf('"Answer":"ABC"')!==-1)
                {
                    result = ("Answer:ABC")
                    alert(result)
                }

                if(result.indexOf('"Answer":"ABCD"')!==-1)
                {
                    result = ("Answer:ABCD")
                    alert(result)
                }

                if(result.indexOf('"Answer":"BC"')!==-1)
                {
                    result = ("Answer:BC")
                    alert(result)
                }

                if(result.indexOf('"Answer":"BCD"')!==-1)
                {
                    result = ("Answer:BCD")
                    alert(result)
                }

                if(result.indexOf('"Answer":"CD"')!==-1)
                {
                    result = ("Answer:CD")
                    alert(result)
                }

                if(result.indexOf('"Answer":"对"')!==-1)
                {
                    result = ("Answer:对")
                    alert(result)
                }

                if(result.indexOf('"Answer":"错"')!==-1)
                {
                    result = ("Answer:错")
                    alert(result)
                }
